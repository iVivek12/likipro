            ...
            <a href="<?php echo base_url.'admin' ?>" class="portal-link">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-image">
                        <span class="img-circle elevation-2 fa fa-user-cog portal-icon"></span>
                    </div>
                    <div class="card-footer bg-info">
                        <div class="container">
                            <p class="text-center text-white-80"><small><i>Click here to Admin Side</i></small></p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-md-4">
            <a href="<?php echo base_url.'faculty' ?>" class="portal-link">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-image">
                        <span class="img-circle elevation-2 fa fa-user-tie portal-icon"></span>
                    </div>
                    <div class="card-footer bg-info">
                        <div class="container">
                            <p class="text-center text-white-80"><small><i>Click here to Establishment Side</i></small></p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-md-4">
            <a href="<?php echo base_url.'student' ?>" class="portal-link">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-image">
                        <span class="img-circle elevation-2 fa fa-users portal-icon"></span>
                    </div>
                    <div class="card-footer bg-info border-info">
                        <div class="container">
                            <p class="text-center text-white-80"><small><i>Click here to Signin or Register</i></small></p>
                        </div>
                    </div>
                </div>
            </a>
